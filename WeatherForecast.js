...
display: 'grid',
placeitems: 'center',
background: 'linear-gradient(-45deg, #ee7752, #e73c7e, #73c7e, #23a6d5, #23d5ab)',
...
<style>{'@ketframes gradient { 0%,100%{background-position:0% 50%}50%{background-position:100% 50%}}'}</style>
</div>
);
}